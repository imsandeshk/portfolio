...
import { Database, Code, BarChart, Teaching, Eye, Robot, Infinity, Computer } from "lucide-react";
...
const InterestsSection: React.FC = () => {
  const interests: Interest[] = [
    ...
    { id: "ai", name: "Artificial Intelligence", icon: <Robot size={20} />, color: "#f39c12" },
    ...
    { id: "beta-testing", name: "Beta Testing", icon: <Eye size={20} />, color: "#3498db" },
    { id: "teaching", name: "Teaching", icon: <Teaching size={20} />, color: "#e74c3c" },
  ];
